        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="space-y-4 text-muted">
            ...
            <p className="font-mono text-xs uppercase tracking-wide text-signal">
              [TODO: заменить на реальный текст «О компании» с mrsys.ru —
              автоматический доступ к странице был заблокирован файлом
              robots.txt, поэтому здесь размещён текст-заглушка]
            </p>
          </div>
        </div>
      </section>
