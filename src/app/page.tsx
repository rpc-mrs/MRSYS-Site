...
const STATS = [
  { value: "720+", label: "поверок проведено с использованием разработанных и утвержденных «ГСО 12699-2024 СО масличности и влажности семян масличных культур и продуктов их переработки (имитаторы) (комплект МРС)»" },
  ...
  { value: "15", label: "ЯМР-анализаторов АКС-2020 было выпущено за неполный год с момента их разработки и утверждения в качестве средства измерения" },
